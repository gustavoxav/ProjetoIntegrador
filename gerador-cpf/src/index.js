...
export function gerarCPF( geradorNumero ) {

    const digitosSemDV = typeof geradorNumero === 'function'
        ? geradorNumero( DIGITOS_CPF_SEM_VERIFICADOR )
        : gerarNumeros( DIGITOS_CPF_SEM_VERIFICADOR );
